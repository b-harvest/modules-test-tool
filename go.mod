module interact-cosmos-data

go 1.18

require (
	github.com/b-harvest/modules-test-tool v0.0.0-20220413085011-539a74e3240b
	github.com/cosmos/cosmos-sdk v0.45.11
	github.com/crescent-network/crescent/v3 v3.0.0
...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/crescent-network/cosmos-sdk v1.1.2-sdk-0.45.9
